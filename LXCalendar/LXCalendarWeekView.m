...
-(void)setWeekTitles:(NSArray *)weekTitles{
    ...
    for (int i = 0; i< weekTitles.count; i++) {
        UILabel *weekLabel =[UILabel LXLabelWithText:weekTitles[i] textColor:[UIColor hexStringToColor:@"666666"] backgroundColor:[UIColor whiteColor] frame:CGRectMake(i * width, 0, width+1, self.lx_height) font:Font(14) textAlignment:NSTextAlignmentCenter];
